...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        <div class="animate-on-scroll">
            ...
            <!-- Titre -->
            <h1 class="text-6xl font-bold text-gray-100 mb-4">419</h1>
            <h2 class="text-2xl font-semibold text-gray-200 mb-4">Page expirée</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="text-sm text-gray-500">
                    <a href="{{ route('home') }}" class="text-blue-400 hover:text-blue-500 underline">
                        Retour à l'accueil
                    </a>
                </div>
            </div>
