...
@section('content')
<div class="min-h-screen bg-gray-50 dark:bg-[#0c0c0f] flex items-center justify-center px-4">
    <!-- Background Pattern -->
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <div class="inline-flex items-center space-x-2 px-4 py-2 bg-red-50 dark:bg-red-900/20 rounded-full mb-4">
        ...
        <div class="bg-white dark:bg-[#1a1a1d] rounded-2xl shadow-xl border border-gray-100 dark:border-white/5 p-8">
            @if($errors->any())
                <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 rounded-lg">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="email" 
                               ...
                               required
                               autofocus
                               class="w-full px-4 py-3 pl-11 border border-gray-300 dark:border-white/20 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors">
        ...
        <div class="mt-8 text-center space-y-4">
            <a href="{{ route('home') }}" 
               class="inline-flex items-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-gray-100 font-medium transition-colors">
