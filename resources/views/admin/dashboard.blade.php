                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Administration Fidow</p>
                        </div>
                    </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div class="text-sm text-gray-600">Générations totales</div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if(\App\Models\Avis::pending()->count() > 0)
                        <span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium animate-pulse">
                            Nouveau
                        </span>
                    @endif
                </div>
                ...
                <div class="text-sm text-gray-600">Avis en attente</div>
                <div class="mt-3">
                    @if(\App\Models\Avis::pending()->count() > 0)
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.avis.index') }}" 
                   class="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all group">
                    ...
                    <div class="flex-1">
                        <div class="font-medium text-gray-900">Gérer les avis</div>
                        <div class="text-sm text-gray-500">{{ \App\Models\Avis::pending()->count() }} en attente</div>
                    </div>
                ...
                <a href="{{ route('admin.data') }}" 
                   class="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all group">
                    ...
                    <div class="flex-1">
                        <div class="font-medium text-gray-900">Voir les statistiques</div>
                        <div class="text-sm text-gray-500">Générations de positionnement</div>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                ...
                <a href="{{ route('admin.llm.index') }}" 
                   class="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-purple-300 hover:shadow-md transition-all group">
                    ...
                    <div class="flex-1">
                        <div class="font-medium text-gray-900">Gérer les LLM</div>
                        <div class="text-sm text-gray-500">Services IA et fallbacks</div>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                ...
                <a href="{{ route('avis.index') }}" target="_blank"
                   class="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all group">
                    ...
                    <div class="flex-1">
                        <div class="font-medium text-gray-900">Voir le site public</div>
                        <div class="text-sm text-gray-500">Page des avis</div>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">Dernières générations</h3>
                    <p class="text-sm text-gray-500 mt-1">Phrases de positionnement récentes</p>
                </div>
                <div class="p-6">
                    @php
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">Aucune génération récente</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Derniers avis des utilisateurs</p>
                </div>
                <div class="p-6">
                    @php
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="px-2 py-0.5 text-xs rounded-full @if($avi->statut == 'pending') bg-yellow-100 text-yellow-700 @else bg-green-100 text-green-700 @endif">
                                        ...
                                        <div class="flex items-center space-x-1 mt-1">
                                            @for($i = 1; $i <= 5; $i++)
                                                ...
                                                @endif
                                            @endfor
                                            <span class="text-xs text-gray-500">({{ $avi->note }}/5)</span>
                                        </div>
                                        <div class="text-xs text-gray-400 mt-1">
