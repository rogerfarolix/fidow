        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-900">{{ $avisPending->count() }}</div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-900">{{ $avisApproved->count() }}</div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-900">{{ number_format($avisApproved->avg('note'), 1) }}</div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-900">{{ $avisPending->count() + $avisApproved->count() }}</div>
                                ...
                                @foreach($avisPending as $avi)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $avi->nom }}</div>
                                            <div class="text-xs text-gray-500">{{ $avi->email }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center space-x-1">
                                                @for($i = 1; $i <= 5; $i++)
                                                    ...
                                                    @endif
                                                @endfor
                                                <span class="ml-2 text-sm text-gray-600">({{ $avi->note }}/5)</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-700 max-w-xs truncate" title="{{ $avi->commentaire }}">
                                                {{ $avi->commentaire }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
        ...
        @else
            <div class="mb-8 p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-1">Tout est à jour !</h3>
                    <p class="text-gray-600">Aucun avis en attente de validation</p>
                </div>
            </div>
        @endif
            ...
            @else
                <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Aucun avis approuvé</h3>
                        <p class="text-gray-600">Les avis approuvés apparaîtront ici</p>
                    </div>
                </div>
            @endif
        </div>
